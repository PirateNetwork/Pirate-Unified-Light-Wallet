...
fn test_light_client_config_socks5() {
    let config = LightClientConfig::with_socks5("https://lightd:9067", "socks5://127.0.0.1:9050");
...
mod live_tests {
    ...
    async fn test_live_get_lightd_info() {
        ...
        assert!(
            info.sapling_activation_height > 0,
            "Sapling activation should be > 0"
        );
