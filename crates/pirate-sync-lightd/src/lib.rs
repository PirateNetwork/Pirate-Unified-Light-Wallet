...
pub use client::{
    ...
    tor_status, BroadcastResult, CompactBlock, CompactBlockChunk, CompactBlockData,
    CompactIronwoodAction, CompactOutput, CompactSaplingOutput, CompactSaplingSpend, CompactTx,
    EndpointHealth, LightClient, LightClientConfig, LightClientEndpoint, LightdInfo, RetryConfig,
