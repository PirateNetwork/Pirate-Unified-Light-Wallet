...
async fn test_node_inner(
    ...
    match client.connect().await {
        ...
        Err(e) => {
            ...
            {
                format!("DNS resolution failed: {}. The hostname '{}' cannot be resolved to an IP address. This may be a DNS configuration issue on your network. Try a known endpoint such as lightd1.pirate.black:443 or check your DNS settings.", cleaned_error, host)
