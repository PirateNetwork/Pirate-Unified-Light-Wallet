...
@protected ffi.Pointer<ffi.Int32> cst_encode_box_autoadd_mnemonic_language(MnemonicLanguage raw){ // Codec=Cst (C-struct based), see doc to use other codecs
return wire.cst_new_box_autoadd_mnemonic_language(cst_encode_mnemonic_language(raw)); }
...
@protected ffi.Pointer<wire_cst_list_mnemonic_language> cst_encode_list_mnemonic_language(List<MnemonicLanguage> raw){ // Codec=Cst (C-struct based), see doc to use other codecs
...
@protected ffi.Pointer<ffi.Int32> cst_encode_opt_box_autoadd_mnemonic_language(MnemonicLanguage? raw){ // Codec=Cst (C-struct based), see doc to use other codecs
return raw == null ? ffi.nullptr : cst_encode_box_autoadd_mnemonic_language(raw); }
...
@protected void cst_api_fill_to_wire_mnemonic_inspection(MnemonicInspection apiObj, wire_cst_mnemonic_inspection wireObj){ wireObj.is_valid = cst_encode_bool(apiObj.isValid);
wireObj.detected_language = cst_encode_opt_box_autoadd_mnemonic_language(apiObj.detectedLanguage);
wireObj.ambiguous_languages = cst_encode_list_mnemonic_language(apiObj.ambiguousLanguages);
...
@protected void cst_api_fill_to_wire_spendability_status(SpendabilityStatus apiObj, wire_cst_spendability_status wireObj){ wireObj.spendable = cst_encode_bool(apiObj.spendable);
...
wireObj.validated_anchor_height = cst_encode_u_64(apiObj.validatedAnchorHeight);
