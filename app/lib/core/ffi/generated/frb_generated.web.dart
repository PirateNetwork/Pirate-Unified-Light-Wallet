...
@protected MnemonicLanguage dco_decode_box_autoadd_mnemonic_language(dynamic raw);
...
@protected List<MnemonicLanguage> dco_decode_list_mnemonic_language(dynamic raw);
...
@protected MnemonicInspection dco_decode_mnemonic_inspection(dynamic raw);

@protected MnemonicLanguage dco_decode_mnemonic_language(dynamic raw);
...
@protected MnemonicLanguage? dco_decode_opt_box_autoadd_mnemonic_language(dynamic raw);
...
@protected SpendabilityStatus dco_decode_spendability_status(dynamic raw);
...
@protected MnemonicLanguage sse_decode_box_autoadd_mnemonic_language(SseDeserializer deserializer);
...
@protected List<MnemonicLanguage> sse_decode_list_mnemonic_language(SseDeserializer deserializer);
...
@protected MnemonicInspection sse_decode_mnemonic_inspection(SseDeserializer deserializer);

@protected MnemonicLanguage sse_decode_mnemonic_language(SseDeserializer deserializer);
...
@protected MnemonicLanguage? sse_decode_opt_box_autoadd_mnemonic_language(SseDeserializer deserializer);
...
@protected SpendabilityStatus sse_decode_spendability_status(SseDeserializer deserializer);
...
@protected int cst_encode_box_autoadd_mnemonic_language(MnemonicLanguage raw){ // Codec=Cst (C-struct based), see doc to use other codecs
...
@protected JSAny cst_encode_list_mnemonic_language(List<MnemonicLanguage> raw){ // Codec=Cst (C-struct based), see doc to use other codecs
...
@protected JSAny cst_encode_mnemonic_inspection(MnemonicInspection raw){ // Codec=Cst (C-struct based), see doc to use other codecs
return [cst_encode_bool(raw.isValid),cst_encode_opt_box_autoadd_mnemonic_language(raw.detectedLanguage),cst_encode_list_mnemonic_language(raw.ambiguousLanguages),cst_encode_u_32(raw.wordCount)].jsify()!; }
...
@protected int? cst_encode_opt_box_autoadd_mnemonic_language(MnemonicLanguage? raw){ // Codec=Cst (C-struct based), see doc to use other codecs
...
@protected JSAny cst_encode_spendability_status(SpendabilityStatus raw){ // Codec=Cst (C-struct based), see doc to use other codecs
return [cst_encode_bool(raw.spendable),cst_encode_bool(raw.rescanRequired),cst_encode_u_64(raw.targetHeight),cst_encode_u_64(raw.anchorHeight),cst_encode_u_64(raw.validatedAnchorHeight),cst_encode_bool(raw.repairQueued),cst_encode_String(raw.reasonCode)].jsify()!; }
...
@protected JSAny cst_encode_witness_refresh_outcome(WitnessRefreshOutcome raw){ // Codec=Cst (C-struct based), see doc to use other codecs
return [cst_encode_String(raw.source),cst_encode_usize(raw.saplingRequested),cst_encode_usize(raw.saplingUpdated),cst_encode_usize(raw.saplingMissing),cst_encode_usize(raw.saplingErrors),cst_encode_usize(raw.orchardRequested),cst_encode_usize(raw.orchardUpdated),cst_encode_usize(raw.orchardMissing),cst_encode_usize(raw.orchardErrors)].jsify()!; }
...
@protected int cst_encode_mnemonic_language(MnemonicLanguage raw);
...
@protected void sse_encode_box_autoadd_mnemonic_language(MnemonicLanguage self, SseSerializer serializer);
...
@protected void sse_encode_list_mnemonic_language(List<MnemonicLanguage> self, SseSerializer serializer);
...
@protected void sse_encode_mnemonic_inspection(MnemonicInspection self, SseSerializer serializer);

@protected void sse_encode_mnemonic_language(MnemonicLanguage self, SseSerializer serializer);
...
@protected void sse_encode_opt_box_autoadd_mnemonic_language(MnemonicLanguage? self, SseSerializer serializer);
...
@protected void sse_encode_spendability_status(SpendabilityStatus self, SseSerializer serializer);
...
void wire__crate__api__tunnel__bootstrap_tunnel(NativePortType port_,JSAny mode) => wasmModule.wire__crate__api__tunnel__bootstrap_tunnel(port_,mode);
...
void wire__crate__api__convert_mnemonic_language(NativePortType port_,String mnemonic,int? source_language,int target_language) => wasmModule.wire__crate__api__convert_mnemonic_language(port_,mnemonic,source_language,target_language);

void wire__crate__api__create_wallet(NativePortType port_,String name,int? _entropy_len,int? birthday_opt,int? mnemonic_language) => wasmModule.wire__crate__api__create_wallet(port_,name,_entropy_len,birthday_opt,mnemonic_language);
...
void wire__crate__api__download_external_to_file(NativePortType port_,String url,String destination_path,String? accept,String? user_agent) => wasmModule.wire__crate__api__download_external_to_file(port_,url,destination_path,accept,user_agent);
...
void wire__crate__api__exit_decoy_mode(NativePortType port_,String passphrase) => wasmModule.wire__crate__api__exit_decoy_mode(port_,passphrase);
...
void wire__crate__api__export_sapling_viewing_key(NativePortType port_,String wallet_id) => wasmModule.wire__crate__api__export_sapling_viewing_key(port_,wallet_id);

void wire__crate__api__export_sapling_viewing_key_secure(NativePortType port_,String wallet_id) => wasmModule.wire__crate__api__export_sapling_viewing_key_secure(port_,wallet_id);

void wire__crate__api__export_seed_raw(NativePortType port_,String wallet_id,int? mnemonic_language) => wasmModule.wire__crate__api__export_seed_raw(port_,wallet_id,mnemonic_language);

void wire__crate__api__export_seed_with_cached_passphrase(NativePortType port_,String wallet_id,int? mnemonic_language) => wasmModule.wire__crate__api__export_seed_with_cached_passphrase(port_,wallet_id,mnemonic_language);

void wire__crate__api__export_seed_with_passphrase(NativePortType port_,String wallet_id,String passphrase,int? mnemonic_language) => wasmModule.wire__crate__api__export_seed_with_passphrase(port_,wallet_id,passphrase,mnemonic_language);

void wire__crate__api__fetch_external_bytes(NativePortType port_,String url,String? accept,String? user_agent) => wasmModule.wire__crate__api__fetch_external_bytes(port_,url,accept,user_agent);

void wire__crate__api__fetch_external_text(NativePortType port_,String url,String? accept,String? user_agent) => wasmModule.wire__crate__api__fetch_external_text(port_,url,accept,user_agent);
...
void wire__crate__api__generate_mnemonic(NativePortType port_,int? word_count,int? mnemonic_language) => wasmModule.wire__crate__api__generate_mnemonic(port_,word_count,mnemonic_language);
...
void wire__crate__api__get_recommended_background_sync_mode(NativePortType port_,String wallet_id,int minutes_since_last) => wasmModule.wire__crate__api__get_recommended_background_sync_mode(port_,wallet_id,minutes_since_last);

void wire__crate__api__background_sync__get_recommended_background_sync_mode(NativePortType port_,String wallet_id,int minutes_since_last) => wasmModule.wire__crate__api__background_sync__get_recommended_background_sync_mode(port_,wallet_id,minutes_since_last);
...
void wire__crate__api__get_spendability_status(NativePortType port_,String wallet_id) => wasmModule.wire__crate__api__get_spendability_status(port_,wallet_id);
...
void wire__crate__api__tunnel__get_tor_status(NativePortType port_) => wasmModule.wire__crate__api__tunnel__get_tor_status(port_);

void wire__crate__api__get_tunnel(NativePortType port_) => wasmModule.wire__crate__api__get_tunnel(port_);

void wire__crate__api__tunnel__get_tunnel(NativePortType port_) => wasmModule.wire__crate__api__tunnel__get_tunnel(port_);
...
void wire__crate__api__import_sapling_viewing_key_as_watch_only(NativePortType port_,String name,String sapling_viewing_key,int birthday_height) => wasmModule.wire__crate__api__import_sapling_viewing_key_as_watch_only(port_,name,sapling_viewing_key,birthday_height);
...
void wire__crate__api__import_viewing_wallet(NativePortType port_,String name,String? sapling_viewing_key,String? orchard_viewing_key,int birthday) => wasmModule.wire__crate__api__import_viewing_wallet(port_,name,sapling_viewing_key,orchard_viewing_key,birthday);

void wire__crate__api__inspect_mnemonic(NativePortType port_,String mnemonic) => wasmModule.wire__crate__api__inspect_mnemonic(port_,mnemonic);
...
void wire__crate__api__background_sync__is_background_sync_needed(NativePortType port_,String wallet_id) => wasmModule.wire__crate__api__background_sync__is_background_sync_needed(port_,wallet_id);
...
void wire__crate__api__endpoint__lightd_endpoint_default(NativePortType port_) => wasmModule.wire__crate__api__endpoint__lightd_endpoint_default(port_);

void wire__crate__api__endpoint__lightd_endpoint_display_string(NativePortType port_,JSAny that) => wasmModule.wire__crate__api__endpoint__lightd_endpoint_display_string(port_,that);

void wire__crate__api__endpoint__lightd_endpoint_url(NativePortType port_,JSAny that) => wasmModule.wire__crate__api__endpoint__lightd_endpoint_url(port_,that);
...
void wire__crate__api__restore_wallet(NativePortType port_,String name,String mnemonic,int? birthday_opt,int? mnemonic_language) => wasmModule.wire__crate__api__restore_wallet(port_,name,mnemonic,birthday_opt,mnemonic_language);

void wire__crate__api__rotate_tor_exit(NativePortType port_) => wasmModule.wire__crate__api__rotate_tor_exit(port_);

void wire__crate__api__tunnel__rotate_tor_exit(NativePortType port_) => wasmModule.wire__crate__api__tunnel__rotate_tor_exit(port_);
...
void wire__crate__api__tunnel__set_tor_bridge_settings(NativePortType port_,bool use_bridges,bool fallback_to_bridges,String transport,JSAny bridge_lines,String? transport_path) => wasmModule.wire__crate__api__tunnel__set_tor_bridge_settings(port_,use_bridges,fallback_to_bridges,transport,bridge_lines,transport_path);

void wire__crate__api__set_tunnel(NativePortType port_,JSAny mode) => wasmModule.wire__crate__api__set_tunnel(port_,mode);

void wire__crate__api__tunnel__set_tunnel(NativePortType port_,JSAny mode) => wasmModule.wire__crate__api__tunnel__set_tunnel(port_,mode);
...
void wire__crate__api__tunnel__shutdown_transport(NativePortType port_) => wasmModule.wire__crate__api__tunnel__shutdown_transport(port_);
...
void wire__crate__api__start_background_sync(NativePortType port_,String wallet_id,String? mode,JSAny? max_duration_secs,JSAny? max_blocks) => wasmModule.wire__crate__api__start_background_sync(port_,wallet_id,mode,max_duration_secs,max_blocks);

void wire__crate__api__background_sync__start_background_sync(NativePortType port_,String wallet_id,String? mode,JSAny? max_duration_secs,JSAny? max_blocks) => wasmModule.wire__crate__api__background_sync__start_background_sync(port_,wallet_id,mode,max_duration_secs,max_blocks);

void wire__crate__api__start_background_sync_round_robin(NativePortType port_,String? mode,JSAny? max_duration_secs,JSAny? max_blocks) => wasmModule.wire__crate__api__start_background_sync_round_robin(port_,mode,max_duration_secs,max_blocks);

void wire__crate__api__background_sync__start_background_sync_round_robin(NativePortType port_,String? mode,JSAny? max_duration_secs,JSAny? max_blocks) => wasmModule.wire__crate__api__background_sync__start_background_sync_round_robin(port_,mode,max_duration_secs,max_blocks);
...
void wire__crate__api__tunnel__test_node(NativePortType port_,String url,String? tls_pin) => wasmModule.wire__crate__api__tunnel__test_node(port_,url,tls_pin);
...
void wire__crate__api__validate_mnemonic(NativePortType port_,String mnemonic,int? mnemonic_language) => wasmModule.wire__crate__api__validate_mnemonic(port_,mnemonic,mnemonic_language);
...
void wire__crate__api__verify_duress_passphrase(NativePortType port_,String passphrase) => wasmModule.wire__crate__api__verify_duress_passphrase(port_,passphrase);
...
void wire__crate__api__witness_refresh_outcome_default(NativePortType port_) => wasmModule.wire__crate__api__witness_refresh_outcome_default(port_);
        }
...
external void wire__crate__api__tunnel__bootstrap_tunnel(NativePortType port_,JSAny mode);
...
external void wire__crate__api__convert_mnemonic_language(NativePortType port_,String mnemonic,int? source_language,int target_language);

external void wire__crate__api__create_wallet(NativePortType port_,String name,int? _entropy_len,int? birthday_opt,int? mnemonic_language);
...
external void wire__crate__api__download_external_to_file(NativePortType port_,String url,String destination_path,String? accept,String? user_agent);

external void wire__crate__api__estimate_fee(NativePortType port_,JSAny num_outputs,bool has_memo,String? fee_policy);

external void wire__crate__api__exit_decoy_mode(NativePortType port_,String passphrase);
...
external void wire__crate__api__export_sapling_viewing_key(NativePortType port_,String wallet_id);

external void wire__crate__api__export_sapling_viewing_key_secure(NativePortType port_,String wallet_id);

external void wire__crate__api__export_seed_raw(NativePortType port_,String wallet_id,int? mnemonic_language);

external void wire__crate__api__export_seed_with_cached_passphrase(NativePortType port_,String wallet_id,int? mnemonic_language);

external void wire__crate__api__export_seed_with_passphrase(NativePortType port_,String wallet_id,String passphrase,int? mnemonic_language);

external void wire__crate__api__fetch_external_bytes(NativePortType port_,String url,String? accept,String? user_agent);

external void wire__crate__api__fetch_external_text(NativePortType port_,String url,String? accept,String? user_agent);
...
external void wire__crate__api__generate_mnemonic(NativePortType port_,int? word_count,int? mnemonic_language);
...
external void wire__crate__api__get_recommended_background_sync_mode(NativePortType port_,String wallet_id,int minutes_since_last);

external void wire__crate__api__background_sync__get_recommended_background_sync_mode(NativePortType port_,String wallet_id,int minutes_since_last);
...
external void wire__crate__api__get_spendability_status(NativePortType port_,String wallet_id);
...
external void wire__crate__api__import_sapling_viewing_key_as_watch_only(NativePortType port_,String name,String sapling_viewing_key,int birthday_height);
...
external void wire__crate__api__import_viewing_wallet(NativePortType port_,String name,String? sapling_viewing_key,String? orchard_viewing_key,int birthday);

external void wire__crate__api__inspect_mnemonic(NativePortType port_,String mnemonic);

external void wire__crate__api__is_background_sync_needed(NativePortType port_,String wallet_id);

external void wire__crate__api__background_sync__is_background_sync_needed(NativePortType port_,String wallet_id);
...
external void wire__crate__api__endpoint__lightd_endpoint_default(NativePortType port_);

external void wire__crate__api__endpoint__lightd_endpoint_display_string(NativePortType port_,JSAny that);

external void wire__crate__api__endpoint__lightd_endpoint_url(NativePortType port_,JSAny that);
...
external void wire__crate__api__restore_wallet(NativePortType port_,String name,String mnemonic,int? birthday_opt,int? mnemonic_language);
...
external void wire__crate__api__tunnel__set_tor_bridge_settings(NativePortType port_,bool use_bridges,bool fallback_to_bridges,String transport,JSAny bridge_lines,String? transport_path);

external void wire__crate__api__set_tunnel(NativePortType port_,JSAny mode);

external void wire__crate__api__tunnel__set_tunnel(NativePortType port_,JSAny mode);
...
external void wire__crate__api__tunnel__shutdown_transport(NativePortType port_);
...
external void wire__crate__api__start_background_sync(NativePortType port_,String wallet_id,String? mode,JSAny? max_duration_secs,JSAny? max_blocks);

external void wire__crate__api__background_sync__start_background_sync(NativePortType port_,String wallet_id,String? mode,JSAny? max_duration_secs,JSAny? max_blocks);

external void wire__crate__api__start_background_sync_round_robin(NativePortType port_,String? mode,JSAny? max_duration_secs,JSAny? max_blocks);

external void wire__crate__api__background_sync__start_background_sync_round_robin(NativePortType port_,String? mode,JSAny? max_duration_secs,JSAny? max_blocks);
...
external void wire__crate__api__tunnel__test_node(NativePortType port_,String url,String? tls_pin);
...
external void wire__crate__api__validate_mnemonic(NativePortType port_,String mnemonic,int? mnemonic_language);

external void wire__crate__api__verify_app_passphrase(NativePortType port_,String passphrase);

external void wire__crate__api__verify_duress_passphrase(NativePortType port_,String passphrase);
...
external void wire__crate__api__witness_refresh_outcome_default(NativePortType port_);
        }
