...
Future<String> crateApiConvertMnemonicLanguage({required String mnemonic , MnemonicLanguage? sourceLanguage , required MnemonicLanguage targetLanguage });

Future<String> crateApiCreateWallet({required String name , int? entropyLen , int? birthdayOpt , MnemonicLanguage? mnemonicLanguage });
...
Future<void> crateApiDownloadExternalToFile({required String url , required String destinationPath , String? accept , String? userAgent });
...
Future<String> crateApiExportSaplingViewingKeySecure({required String walletId });

Future<String> crateApiExportSeedRaw({required String walletId , MnemonicLanguage? mnemonicLanguage });

Future<List<String>> crateApiExportSeedWithCachedPassphrase({required String walletId , MnemonicLanguage? mnemonicLanguage });

Future<List<String>> crateApiExportSeedWithPassphrase({required String walletId , required String passphrase , MnemonicLanguage? mnemonicLanguage });

Future<Uint8List> crateApiFetchExternalBytes({required String url , String? accept , String? userAgent });

Future<String> crateApiFetchExternalText({required String url , String? accept , String? userAgent });
...
Future<String> crateApiGenerateMnemonic({int? wordCount , MnemonicLanguage? mnemonicLanguage });
...
Future<String> crateApiBackgroundSyncGetRecommendedBackgroundSyncMode({required String walletId , required int minutesSinceLast });
...
Future<SpendabilityStatus> crateApiGetSpendabilityStatus({required String walletId });
...
Future<String> crateApiImportSaplingViewingKeyAsWatchOnly({required String name , required String saplingViewingKey , required int birthdayHeight });
...
Future<String> crateApiImportViewingWallet({required String name , String? saplingViewingKey , String? orchardViewingKey , required int birthday });

Future<MnemonicInspection> crateApiInspectMnemonic({required String mnemonic });

Future<bool> crateApiIsBackgroundSyncNeeded({required String walletId });

Future<bool> crateApiBackgroundSyncIsBackgroundSyncNeeded({required String walletId });
...
Future<String> crateApiEndpointLightdEndpointDisplayString({required LightdEndpoint that });

Future<String> crateApiEndpointLightdEndpointUrl({required LightdEndpoint that });
...
Future<String> crateApiRestoreWallet({required String name , required String mnemonic , int? birthdayOpt , MnemonicLanguage? mnemonicLanguage });
...
Future<void> crateApiTunnelSetTorBridgeSettings({required bool useBridges , required bool fallbackToBridges , required String transport , required List<String> bridgeLines , String? transportPath });
...
Future<BackgroundSyncResult> crateApiStartBackgroundSync({required String walletId , String? mode , BigInt? maxDurationSecs , BigInt? maxBlocks });

Future<BackgroundSyncResult> crateApiBackgroundSyncStartBackgroundSync({required String walletId , String? mode , BigInt? maxDurationSecs , BigInt? maxBlocks });

Future<WalletBackgroundSyncResult> crateApiStartBackgroundSyncRoundRobin({String? mode , BigInt? maxDurationSecs , BigInt? maxBlocks });

Future<WalletBackgroundSyncResult> crateApiBackgroundSyncStartBackgroundSyncRoundRobin({String? mode , BigInt? maxDurationSecs , BigInt? maxBlocks });
...
Future<NodeTestResult> crateApiTunnelTestNode({required String url , String? tlsPin });
...
Future<bool> crateApiValidateMnemonic({required String mnemonic , MnemonicLanguage? mnemonicLanguage });
...
@override Future<void> crateApiTunnelBootstrapTunnel({required TunnelMode mode })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
              var arg0 = cst_encode_box_autoadd_tunnel_mode(mode);
        ...
        TaskConstMeta get kCrateApiTunnelBootstrapTunnelConstMeta => const TaskConstMeta(
            debugName: "bootstrap_tunnel",
            argNames: ["mode"],
        );
...
@override Future<String> crateApiConvertMnemonicLanguage({required String mnemonic , MnemonicLanguage? sourceLanguage , required MnemonicLanguage targetLanguage })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
              var arg0 = cst_encode_String(mnemonic);
var arg1 = cst_encode_opt_box_autoadd_mnemonic_language(sourceLanguage);
var arg2 = cst_encode_mnemonic_language(targetLanguage);
            return wire.wire__crate__api__convert_mnemonic_language(port_, arg0, arg1, arg2);
        ...
        TaskConstMeta get kCrateApiConvertMnemonicLanguageConstMeta => const TaskConstMeta(
            debugName: "convert_mnemonic_language",
            argNames: ["mnemonic", "sourceLanguage", "targetLanguage"],
        );
        

@override Future<String> crateApiCreateWallet({required String name , int? entropyLen , int? birthdayOpt , MnemonicLanguage? mnemonicLanguage })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
...
var arg3 = cst_encode_opt_box_autoadd_mnemonic_language(mnemonicLanguage);
            return wire.wire__crate__api__create_wallet(port_, arg0, arg1, arg2, arg3);
...
@override Future<void> crateApiDownloadExternalToFile({required String url , required String destinationPath , String? accept , String? userAgent })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
...
var arg3 = cst_encode_opt_String(userAgent);
            return wire.wire__crate__api__download_external_to_file(port_, arg0, arg1, arg2, arg3);
        ...
        TaskConstMeta get kCrateApiDownloadExternalToFileConstMeta => const TaskConstMeta(
...
@override Future<void> crateApiExitDecoyMode({required String passphrase })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
...
@override Future<String> crateApiExportSaplingViewingKey({required String walletId })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
              var arg0 = cst_encode_String(walletId);
        ...
        TaskConstMeta get kCrateApiExportSaplingViewingKeyConstMeta => const TaskConstMeta(
            debugName: "export_sapling_viewing_key",
            argNames: ["walletId"],
        );
        

@override Future<String> crateApiExportSaplingViewingKeySecure({required String walletId })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
              var arg0 = cst_encode_String(walletId);
            return wire.wire__crate__api__export_sapling_viewing_key_secure(port_, arg0);
        ...
        TaskConstMeta get kCrateApiExportSaplingViewingKeySecureConstMeta => const TaskConstMeta(
            debugName: "export_sapling_viewing_key_secure",
            argNames: ["walletId"],
        );
        

@override Future<String> crateApiExportSeedRaw({required String walletId , MnemonicLanguage? mnemonicLanguage })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
              var arg0 = cst_encode_String(walletId);
var arg1 = cst_encode_opt_box_autoadd_mnemonic_language(mnemonicLanguage);
...
@override Future<List<String>> crateApiExportSeedWithCachedPassphrase({required String walletId , MnemonicLanguage? mnemonicLanguage })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
              var arg0 = cst_encode_String(walletId);
var arg1 = cst_encode_opt_box_autoadd_mnemonic_language(mnemonicLanguage);
            return wire.wire__crate__api__export_seed_with_cached_passphrase(port_, arg0, arg1);
...
@override Future<List<String>> crateApiExportSeedWithPassphrase({required String walletId , required String passphrase , MnemonicLanguage? mnemonicLanguage })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
              var arg0 = cst_encode_String(walletId);
var arg1 = cst_encode_String(passphrase);
var arg2 = cst_encode_opt_box_autoadd_mnemonic_language(mnemonicLanguage);
            return wire.wire__crate__api__export_seed_with_passphrase(port_, arg0, arg1, arg2);
...
@override Future<Uint8List> crateApiFetchExternalBytes({required String url , String? accept , String? userAgent })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
              var arg0 = cst_encode_String(url);
var arg1 = cst_encode_opt_String(accept);
var arg2 = cst_encode_opt_String(userAgent);
            return wire.wire__crate__api__fetch_external_bytes(port_, arg0, arg1, arg2);
...
@override Future<String> crateApiFetchExternalText({required String url , String? accept , String? userAgent })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
              var arg0 = cst_encode_String(url);
var arg1 = cst_encode_opt_String(accept);
var arg2 = cst_encode_opt_String(userAgent);
            return wire.wire__crate__api__fetch_external_text(port_, arg0, arg1, arg2);
...
@override Future<String> crateApiGenerateMnemonic({int? wordCount , MnemonicLanguage? mnemonicLanguage })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
...
@override Future<String> crateApiBackgroundSyncGetRecommendedBackgroundSyncMode({required String walletId , required int minutesSinceLast })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
              var arg0 = cst_encode_String(walletId);
var arg1 = cst_encode_u_32(minutesSinceLast);
            return wire.wire__crate__api__background_sync__get_recommended_background_sync_mode(port_, arg0, arg1);
        ...
        ,
            constMeta: kCrateApiBackgroundSyncGetRecommendedBackgroundSyncModeConstMeta,
            argValues: [walletId, minutesSinceLast],
            apiImpl: this,
        )); }


        TaskConstMeta get kCrateApiBackgroundSyncGetRecommendedBackgroundSyncModeConstMeta => const TaskConstMeta(
            debugName: "get_recommended_background_sync_mode",
            argNames: ["walletId", "minutesSinceLast"],
        );
...
@override Future<SpendabilityStatus> crateApiGetSpendabilityStatus({required String walletId })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
              var arg0 = cst_encode_String(walletId);
        ...
        TaskConstMeta get kCrateApiGetSpendabilityStatusConstMeta => const TaskConstMeta(
...
@override Future<String> crateApiTunnelGetTorStatus()  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
        ...
        TaskConstMeta get kCrateApiTunnelGetTorStatusConstMeta => const TaskConstMeta(
            debugName: "get_tor_status",
            argNames: [],
        );
...
@override Future<TunnelMode> crateApiTunnelGetTunnel()  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
        ...
        TaskConstMeta get kCrateApiTunnelGetTunnelConstMeta => const TaskConstMeta(
            debugName: "get_tunnel",
            argNames: [],
        );
...
@override Future<String> crateApiImportSaplingViewingKeyAsWatchOnly({required String name , required String saplingViewingKey , required int birthdayHeight })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
              var arg0 = cst_encode_String(name);
var arg1 = cst_encode_String(saplingViewingKey);
var arg2 = cst_encode_u_32(birthdayHeight);
            return wire.wire__crate__api__import_sapling_viewing_key_as_watch_only(port_, arg0, arg1, arg2);
        ...
        TaskConstMeta get kCrateApiImportSaplingViewingKeyAsWatchOnlyConstMeta => const TaskConstMeta(
...
@override Future<String> crateApiImportViewingWallet({required String name , String? saplingViewingKey , String? orchardViewingKey , required int birthday })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
              var arg0 = cst_encode_String(name);
...
var arg3 = cst_encode_u_32(birthday);
            return wire.wire__crate__api__import_viewing_wallet(port_, arg0, arg1, arg2, arg3);
        ...
        TaskConstMeta get kCrateApiImportViewingWalletConstMeta => const TaskConstMeta(
            ...
            argNames: ["name", "saplingViewingKey", "orchardViewingKey", "birthday"],
        );
        

@override Future<MnemonicInspection> crateApiInspectMnemonic({required String mnemonic })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
              var arg0 = cst_encode_String(mnemonic);
...
@override Future<bool> crateApiBackgroundSyncIsBackgroundSyncNeeded({required String walletId })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
              var arg0 = cst_encode_String(walletId);
            return wire.wire__crate__api__background_sync__is_background_sync_needed(port_, arg0);
        ...
        TaskConstMeta get kCrateApiBackgroundSyncIsBackgroundSyncNeededConstMeta => const TaskConstMeta(
            debugName: "is_background_sync_needed",
            argNames: ["walletId"],
        );
...
@override Future<LightdEndpoint> crateApiEndpointLightdEndpointDefault()  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
              
            return wire.wire__crate__api__endpoint__lightd_endpoint_default(port_);
        ...
        TaskConstMeta get kCrateApiEndpointLightdEndpointDefaultConstMeta => const TaskConstMeta(
            debugName: "lightd_endpoint_default",
            argNames: [],
        );
        

@override Future<String> crateApiEndpointLightdEndpointDisplayString({required LightdEndpoint that })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
              var arg0 = cst_encode_box_autoadd_lightd_endpoint(that);
            return wire.wire__crate__api__endpoint__lightd_endpoint_display_string(port_, arg0);
        ...
        TaskConstMeta get kCrateApiEndpointLightdEndpointDisplayStringConstMeta => const TaskConstMeta(
            debugName: "lightd_endpoint_display_string",
            argNames: ["that"],
        );
        

@override Future<String> crateApiEndpointLightdEndpointUrl({required LightdEndpoint that })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
              var arg0 = cst_encode_box_autoadd_lightd_endpoint(that);
            return wire.wire__crate__api__endpoint__lightd_endpoint_url(port_, arg0);
        ...
        TaskConstMeta get kCrateApiEndpointLightdEndpointUrlConstMeta => const TaskConstMeta(
...
@override Future<String> crateApiRestoreWallet({required String name , required String mnemonic , int? birthdayOpt , MnemonicLanguage? mnemonicLanguage })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
              var arg0 = cst_encode_String(name);
...
@override Future<void> crateApiTunnelRotateTorExit()  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
        ...
        TaskConstMeta get kCrateApiTunnelRotateTorExitConstMeta => const TaskConstMeta(
            debugName: "rotate_tor_exit",
            argNames: [],
        );
...
@override Future<void> crateApiSetDuressPassphrase({String? customPassphrase })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
...
@override Future<void> crateApiTunnelSetTorBridgeSettings({required bool useBridges , required bool fallbackToBridges , required String transport , required List<String> bridgeLines , String? transportPath })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
              var arg0 = cst_encode_bool(useBridges);
var arg1 = cst_encode_bool(fallbackToBridges);
var arg2 = cst_encode_String(transport);
var arg3 = cst_encode_list_String(bridgeLines);
var arg4 = cst_encode_opt_String(transportPath);
            return wire.wire__crate__api__tunnel__set_tor_bridge_settings(port_, arg0, arg1, arg2, arg3, arg4);
        ...
        TaskConstMeta get kCrateApiTunnelSetTorBridgeSettingsConstMeta => const TaskConstMeta(
            debugName: "set_tor_bridge_settings",
            argNames: ["useBridges", "fallbackToBridges", "transport", "bridgeLines", "transportPath"],
        );
...
@override Future<void> crateApiTunnelSetTunnel({required TunnelMode mode })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
              var arg0 = cst_encode_box_autoadd_tunnel_mode(mode);
        ...
        TaskConstMeta get kCrateApiTunnelSetTunnelConstMeta => const TaskConstMeta(
            debugName: "set_tunnel",
            argNames: ["mode"],
        );
...
@override Future<void> crateApiTunnelShutdownTransport()  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
        ...
        TaskConstMeta get kCrateApiTunnelShutdownTransportConstMeta => const TaskConstMeta(
            debugName: "shutdown_transport",
            argNames: [],
        );
...
@override Future<BackgroundSyncResult> crateApiStartBackgroundSync({required String walletId , String? mode , BigInt? maxDurationSecs , BigInt? maxBlocks })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
              var arg0 = cst_encode_String(walletId);
...
var arg3 = cst_encode_opt_box_autoadd_u_64(maxBlocks);
            return wire.wire__crate__api__start_background_sync(port_, arg0, arg1, arg2, arg3);
...
@override Future<BackgroundSyncResult> crateApiBackgroundSyncStartBackgroundSync({required String walletId , String? mode , BigInt? maxDurationSecs , BigInt? maxBlocks })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
              var arg0 = cst_encode_String(walletId);
var arg1 = cst_encode_opt_String(mode);
var arg2 = cst_encode_opt_box_autoadd_u_64(maxDurationSecs);
var arg3 = cst_encode_opt_box_autoadd_u_64(maxBlocks);
            return wire.wire__crate__api__background_sync__start_background_sync(port_, arg0, arg1, arg2, arg3);
        ...
        TaskConstMeta get kCrateApiBackgroundSyncStartBackgroundSyncConstMeta => const TaskConstMeta(
            debugName: "start_background_sync",
            argNames: ["walletId", "mode", "maxDurationSecs", "maxBlocks"],
        );
        

@override Future<WalletBackgroundSyncResult> crateApiStartBackgroundSyncRoundRobin({String? mode , BigInt? maxDurationSecs , BigInt? maxBlocks })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
...
var arg2 = cst_encode_opt_box_autoadd_u_64(maxBlocks);
            return wire.wire__crate__api__start_background_sync_round_robin(port_, arg0, arg1, arg2);
...
@override Future<WalletBackgroundSyncResult> crateApiBackgroundSyncStartBackgroundSyncRoundRobin({String? mode , BigInt? maxDurationSecs , BigInt? maxBlocks })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
              var arg0 = cst_encode_opt_String(mode);
var arg1 = cst_encode_opt_box_autoadd_u_64(maxDurationSecs);
var arg2 = cst_encode_opt_box_autoadd_u_64(maxBlocks);
            return wire.wire__crate__api__background_sync__start_background_sync_round_robin(port_, arg0, arg1, arg2);
        ...
        ,
            constMeta: kCrateApiBackgroundSyncStartBackgroundSyncRoundRobinConstMeta,
            argValues: [mode, maxDurationSecs, maxBlocks],
            apiImpl: this,
        )); }


        TaskConstMeta get kCrateApiBackgroundSyncStartBackgroundSyncRoundRobinConstMeta => const TaskConstMeta(
            debugName: "start_background_sync_round_robin",
            argNames: ["mode", "maxDurationSecs", "maxBlocks"],
        );
...
@override Future<NodeTestResult> crateApiTunnelTestNode({required String url , String? tlsPin })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
              var arg0 = cst_encode_String(url);
var arg1 = cst_encode_opt_String(tlsPin);
        ...
        TaskConstMeta get kCrateApiTunnelTestNodeConstMeta => const TaskConstMeta(
            debugName: "test_node",
            argNames: ["url", "tlsPin"],
        );
...
@override Future<bool> crateApiValidateMnemonic({required String mnemonic , MnemonicLanguage? mnemonicLanguage })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
              var arg0 = cst_encode_String(mnemonic);
var arg1 = cst_encode_opt_box_autoadd_mnemonic_language(mnemonicLanguage);
...
@override Future<bool> crateApiVerifyDuressPassphrase({required String passphrase })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
              var arg0 = cst_encode_String(passphrase);
...
@protected MnemonicLanguage dco_decode_box_autoadd_mnemonic_language(dynamic raw){ // Codec=Dco (DartCObject based), see doc to use other codecs
...
@protected List<MnemonicLanguage> dco_decode_list_mnemonic_language(dynamic raw){ // Codec=Dco (DartCObject based), see doc to use other codecs
...
@protected MnemonicInspection dco_decode_mnemonic_inspection(dynamic raw){ // Codec=Dco (DartCObject based), see doc to use other codecs
final arr = raw as List<dynamic>;
                if (arr.length != 4) throw Exception('unexpected arr length: expect 4 but see ${arr.length}');
                return MnemonicInspection(isValid: dco_decode_bool(arr[0]),
...
@protected MnemonicLanguage dco_decode_mnemonic_language(dynamic raw){ // Codec=Dco (DartCObject based), see doc to use other codecs
...
@protected MnemonicLanguage? dco_decode_opt_box_autoadd_mnemonic_language(dynamic raw){ // Codec=Dco (DartCObject based), see doc to use other codecs
...
@protected SpendabilityStatus dco_decode_spendability_status(dynamic raw){ // Codec=Dco (DartCObject based), see doc to use other codecs
final arr = raw as List<dynamic>;
                if (arr.length != 7) throw Exception('unexpected arr length: expect 7 but see ${arr.length}');
                return SpendabilityStatus(spendable: dco_decode_bool(arr[0]),
...
@protected MnemonicLanguage sse_decode_box_autoadd_mnemonic_language(SseDeserializer deserializer){ // Codec=Sse (Serialization based), see doc to use other codecs
...
@protected List<MnemonicLanguage> sse_decode_list_mnemonic_language(SseDeserializer deserializer){ // Codec=Sse (Serialization based), see doc to use other codecs

        var len_ = sse_decode_i_32(deserializer);
        var ans_ = <MnemonicLanguage>[];
        for (var idx_ = 0; idx_ < len_; ++idx_) { ans_.add(sse_decode_mnemonic_language(deserializer)); }
        return ans_;
         }
...
@protected MnemonicInspection sse_decode_mnemonic_inspection(SseDeserializer deserializer){ // Codec=Sse (Serialization based), see doc to use other codecs
var var_isValid = sse_decode_bool(deserializer);
var var_detectedLanguage = sse_decode_opt_box_autoadd_mnemonic_language(deserializer);
var var_ambiguousLanguages = sse_decode_list_mnemonic_language(deserializer);
var var_wordCount = sse_decode_u_32(deserializer);
return MnemonicInspection(isValid: var_isValid, detectedLanguage: var_detectedLanguage, ambiguousLanguages: var_ambiguousLanguages, wordCount: var_wordCount); }

@protected MnemonicLanguage sse_decode_mnemonic_language(SseDeserializer deserializer){ // Codec=Sse (Serialization based), see doc to use other codecs
var inner = sse_decode_i_32(deserializer);
...
@protected MnemonicLanguage? sse_decode_opt_box_autoadd_mnemonic_language(SseDeserializer deserializer){ // Codec=Sse (Serialization based), see doc to use other codecs
...
@protected SpendabilityStatus sse_decode_spendability_status(SseDeserializer deserializer){ // Codec=Sse (Serialization based), see doc to use other codecs
var var_spendable = sse_decode_bool(deserializer);
...
return SpendabilityStatus(spendable: var_spendable, rescanRequired: var_rescanRequired, targetHeight: var_targetHeight, anchorHeight: var_anchorHeight, validatedAnchorHeight: var_validatedAnchorHeight, repairQueued: var_repairQueued, reasonCode: var_reasonCode); }
...
@protected int cst_encode_mnemonic_language(MnemonicLanguage raw){ // Codec=Cst (C-struct based), see doc to use other codecs
return cst_encode_i_32(raw.index); }
...
@protected void sse_encode_box_autoadd_mnemonic_language(MnemonicLanguage self, SseSerializer serializer){ // Codec=Sse (Serialization based), see doc to use other codecs
...
@protected void sse_encode_list_mnemonic_language(List<MnemonicLanguage> self, SseSerializer serializer){ // Codec=Sse (Serialization based), see doc to use other codecs
sse_encode_i_32(self.length, serializer);
        for (final item in self) { sse_encode_mnemonic_language(item, serializer); } }
...
@protected void sse_encode_mnemonic_inspection(MnemonicInspection self, SseSerializer serializer){ // Codec=Sse (Serialization based), see doc to use other codecs
sse_encode_bool(self.isValid, serializer);
sse_encode_opt_box_autoadd_mnemonic_language(self.detectedLanguage, serializer);
sse_encode_list_mnemonic_language(self.ambiguousLanguages, serializer);
sse_encode_u_32(self.wordCount, serializer);
 }

@protected void sse_encode_mnemonic_language(MnemonicLanguage self, SseSerializer serializer){ // Codec=Sse (Serialization based), see doc to use other codecs
sse_encode_i_32(self.index, serializer); }
...
@protected void sse_encode_opt_box_autoadd_mnemonic_language(MnemonicLanguage? self, SseSerializer serializer){ // Codec=Sse (Serialization based), see doc to use other codecs
...
@protected void sse_encode_spendability_status(SpendabilityStatus self, SseSerializer serializer){ // Codec=Sse (Serialization based), see doc to use other codecs
sse_encode_bool(self.spendable, serializer);
