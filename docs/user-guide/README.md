...
2. [Home, Actions, Activity, and Settings](wallet-basics.md)
...
| Phone | Desktop |
|---|---|
| ![Stashi Wallet welcome screen on a phone](images/welcome-phone.png) | ![Stashi Wallet welcome screen on desktop](images/welcome-desktop.png) |
