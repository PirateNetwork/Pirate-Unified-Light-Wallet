...
disclosure lets someone decrypt that specific Sapling output or Orchard action;
...
- `payment-disclosure orchard [--wallet-id <WALLET_ID>] <TXID> <ACTION_INDEX>`
  - Output: Orchard disclosure string
